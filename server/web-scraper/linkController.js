...
courseChoices = [
  // this data was an can be scraped if new courses are added to university
  "ABORIG",
  "ACCTFIN",
  "ACCTING",
  "ACUCARE",
...
const promiseA = (async () => {
  ...
  await page.type('select[name="subject"]', formValue);
  ...
  const classes = await page.evaluate(() => {
    const subjectArray = document.querySelectorAll(
